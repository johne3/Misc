...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		print "Armoury and about to pull and weapon and blast you."
		...
		if action == "shoot!":
			...
			print "Like a world class boxer, weave, slip and slide right"
			...
			print "The Gothon stops, tries not to laugh, then bursts our laughing and can't move."
			print "While he's laughing you run up and shoot him sqauare in the head"
